...
export const Footer = () => {
  ...
  return (
    <footer className="bg-blue-200 dark:bg-blue-900 border-t border-gray-300 dark:border-white/10 text-gray-900 dark:text-white pt-16 pb-8 transition-colors duration-300">
      <Container>
