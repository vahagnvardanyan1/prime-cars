...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[#f0f4f8] dark:bg-[#0b0f14] border-t border-gray-300 dark:border-white/10 text-gray-900 dark:text-white pt-16 pb-8 transition-colors duration-300">
      <Container>
