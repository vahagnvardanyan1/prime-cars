...
export const Footer = () => {
  ...
  return (
    <footer className="bg-[#f5f5f5] dark:bg-[#1a1a1a] border-t border-gray-300 dark:border-white/10 text-gray-900 dark:text-white pt-16 pb-8 transition-colors duration-300">
      <Container>
