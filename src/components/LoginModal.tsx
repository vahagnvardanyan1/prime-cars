    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative bg-white dark:bg-[#111111] border border-gray-300 dark:border-white/10 rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden animate-[scale-in_0.2s_ease-out] transition-colors duration-300">
        ...
        <div className="relative px-8 pt-8 pb-6 border-b border-gray-300 dark:border-white/10">
          ...
          <h2 className="text-gray-900 dark:text-white">{t("auth.welcomeBack")}</h2>
        ...
        <div className="p-8">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder={
                  loginType === "email" ? "you@example.com" : "+1 (555) 000-0000"
                }
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              type="button"
              className="py-3 px-4 border border-gray-300 dark:border-white/20 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 transition-all flex items-center justify-center gap-2 text-gray-900 dark:text-white"
            >
